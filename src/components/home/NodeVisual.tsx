  ...
  return (
    <section className="relative h-[600px] w-full glass-card rounded-xl overflow-hidden group">
      <div className="absolute inset-0 z-0 opacity-40">
          <div className="absolute inset-0 z-10 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-secondary-container/20 via-transparent to-transparent pointer-events-none"></div>

          {/* ⚡ Bolt Optimization: Replaced raw <img> with Next.js <Image> component.
              Impact: Provides native lazy loading, prevents layout shift, and reduces initial load overhead.
              Using unoptimized={true} to bypass next.config.ts external domain configuration requirement
              while still getting lazy-loading and decoding='async' benefits. */}
          <Image
